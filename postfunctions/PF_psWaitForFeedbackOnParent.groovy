...
Logger log = Logger.getLogger("PF_psWaitForFeedbackOnParent")
...
TransitionIssueUtil.transitionIssueByTransitionName(parentIssue, "Waiting for Feedback")
String commentForParent = "waiting for feedback on child issue ${issue.key}"
...
String commentForChild = "wait for feedback on parent issue ${parentIssue.key} automatically"
