...
Long timeBudgetFieldId = FieldsUsage.FEATURE_TIME_BUDGET_FIELD_ID()  // Feature Time Budget
Long remainingTimeFieldId = FieldsUsage.FEATURE_TIME_REMAINING_FIELD_ID()  // Feature Time Remaining
