...
Logger log = Logger.getLogger("epic_time_remaining")

// Using the Epic Time Budget Field ID from FieldsUsage class
Long timeBudgetFieldId = FieldsUsage.EPIC_TIME_BUDGET_FIELD_ID()
