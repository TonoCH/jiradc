...
Logger log = Logger.getLogger("feature_time_remaining")

// Using the Feature Time Budget Field ID from FieldsUsage class
Long timeBudgetFieldId = FieldsUsage.FEATURE_TIME_BUDGET_FIELD_ID()
