...
class FunctionalAreaIssue extends BaseIssueCreator {
    ...
    private static final String issueTypeQuestion = "12703" //"12100"
    private static final Map<String,String> SOURCE_TO_TARGET_CF = [
            // source keys          target keys
            "customfield_16302" : "Functional Area Key",
            "customfield_16801" : "KVS PC Sub-Area",
    ]
    ...
    void fillFields(IssueInputParameters params, Map<String, String> data) {
        ...
        setSingleSelectField("Functional Area Key", data[TARGET_TO_SOURCE_CF.get("Functional Area Key")])
        setSingleSelectField("KVS PC Sub-Area", data[TARGET_TO_SOURCE_CF.get("KVS PC Sub-Area")])
    }
